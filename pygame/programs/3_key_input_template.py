...
# TODO: MAKE X,Y SPEED AND POSITION VARIABLES
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            # TODO: FILL IN WHAT HAPPENS ON KEYDOWN
        elif event.type == pygame.KEYUP:
            # TODO: FILL IN WHAT HAPPENS ON KEYUP

    screen.fill('white')

    # TODO: UPDATE POSITION VARIABLES AND DRAW STICK MAN
